            ...
            <div class="flex items-start justify-between border-b border-gray-100 px-6 py-4 dark:border-white/10">
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                        {{ $truckId ? 'Editar categoría' : 'Nueva categoría' }}
                    </h3>
            ...
            <form wire:submit.prevent="save" class="space-y-5 px-6 py-5">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input
                            type="text"
                            wire:model.defer="license_plate"
                            ...
                            placeholder="Ej. DSR-435, JGH-221, etc..."
                        >
                    </div>
                    @error('license_plate')
                    ...
                    <div class="mt-1">
                        <input
                            ...
                            class="block w-full rounded-md border-gray-300 bg-white py-2 px-3 text-sm text-gray-900 shadow-sm
                                       focus:border-indigo-500 focus:ring-indigo-500
                                       dark:border-white/15 dark:bg-gray-900 dark:text-gray-100"
                            placeholder="Ej. Tortón, Volteo, etc..."
                        >
                    </div>
                    @error('type')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    ...
                    <div class="mt-1">
                        <input
                            ...
                            class="block w-full rounded-md border-gray-300 bg-white py-2 px-3 text-sm text-gray-900 shadow-sm
                                       focus:border-indigo-500 focus:ring-indigo-500
                                       dark:border-white/15 dark:bg-gray-900 dark:text-gray-100"
                            placeholder="Ej. 14 m3, 20 m3, etc..."
                        >
                    </div>
                    @error('capacity')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    ...
                    <div class="mt-1">
                        <input
                            ...
                            class="block w-full rounded-md border-gray-300 bg-white py-2 px-3 text-sm text-gray-900 shadow-sm
                                       focus:border-indigo-500 focus:ring-indigo-500
                                       dark:border-white/15 dark:bg-gray-900 dark:text-gray-100"
                            placeholder="Ej. descrición de la unidad..."
                        >
                    </div>
                    @error('description')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                ...
                <div class="flex items-center justify-end gap-3 pt-2 border-t border-gray-100 dark:border-white/10">
                    ...
                    >
                        ...
                        <span>{{ $truckId ? 'Guardar cambios' : 'Crear unidad' }}</span>
                    </button>
                </div>
            </form>
        </div>
