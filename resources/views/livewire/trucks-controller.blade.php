<div class="px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-base font-semibold text-gray-900 dark:text-white">
                Categorías para las Camiones
            </h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-300 max-w-2xl">
                Administra las categorías por camiones.
            </p>
        </div>
                    ...
                    @forelse($categories as $category)
                        <tr>
                            <td class="whitespace-nowrap py-3 pl-4 pr-3 text-sm text-gray-900 sm:pl-6 dark:text-white ">
                                <span class="inline-flex items-center rounded-md bg-pink-50 text-pink-700 ring-pink-600/20 dark:bg-pink-900/30 dark:text-pink-300 dark:ring-pink-500/50 px-2 py-1 text-xs font-medium ring-1 ring-inset">
                                    {{ $category->license_plate }}
                                </span>
                            </td>
                            <td class="whitespace-nowrap py-3 pl-4 pr-3 text-sm text-gray-900 sm:pl-6 dark:text-white">
                                <span class="inline-flex items-center rounded-md bg-purple-50 text-purple-700 ring-purple-600/20 dark:bg-purple-900/30 dark:text-purple-300 dark:ring-purple-500/50 px-2 py-1 text-xs font-medium ring-1 ring-inset">
                                    {{ $category->model }}
                                </span>
                            </td>
                            <td class="whitespace-nowrap py-3 pl-4 pr-3 text-sm text-gray-900 sm:pl-6 dark:text-white">
                                <span class="inline-flex items-center rounded-md bg-orange-50 text-orange-700 ring-orange-600/20 dark:bg-orange-900/30 dark:text-orange-300 dark:ring-orange-500/50 px-2 py-1 text-xs font-medium ring-1 ring-inset">
                                    {{ $category->type }}
                                </span>
                            </td>
    ...
    @include('livewire.modals.truck-form')
