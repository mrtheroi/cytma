...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('empleados', function (Blueprint $table) {
            ...
            $table->decimal('sueldo_pactado', 10, 4)->default(0)->comment('Sueldo base acordado con el empleado para el período');
            $table->decimal('costo_dia', 10, 4)->default(0);
            $table->decimal('costo_hora', 10, 4)->default(0);
            $table->decimal('costo_hora_extra', 10, 4)->default(0);
